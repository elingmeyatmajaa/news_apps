            ...
            <div class="navbar-bottom">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <a class="navbar-brand" href="/"><img src="{{asset('storage/settings/logo/'.$settings->site_logo)}}" alt="" /></a>
                  @else
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="footer-border-bottom pb-2">
                        <div class="row">
                          <div class="col-3">
                            <img src="{{asset('storage/posts/'.$post->image)}}" alt="thumb" class="img-fluid" />
                          </div>
                          <div class="col-9">
