  ...
  <div class="col-xl-8 stretch-card grid-margin">
    ...
    <a href="{{route('client.post', $latest_breaking_news->id)}}">
      <div class="position-relative">
        <img src="{{asset('storage/posts/'.$latest_breaking_news->image)}}" alt="banner" class="img-fluid" />
        ...
        <a class="text-light" href="{{route('client.post', $news->id)}}">
          <div class="d-flex border-bottom-blue pt-3 pb-4 align-items-center justify-content-between">
            ...
            <div class="rotate-img">
              <img src="{{asset('storage/posts/'.$news->image)}}" alt="thumb" class="img-fluid img-lg" />
            </div>
          </div>
        </a>
        @endforeach
        ...
        <a href="{{route('client.post', $news->id)}}" class="text-dark">
          <div class="row">
            <div class="col-sm-4 grid-margin">
              <div class="position-relative">
                <div class="rotate-img">
                  <img src="{{asset('storage/posts/'.$news->image)}}" alt="thumb" class="img-fluid" />
                </div>
            ...
            <div class="row">
              ...
              <a href="{{$video->url}}">
                <div class="col-sm-6 grid-margin">
                  <div class="position-relative">
                    <div class="rotate-img">
                      <img src="{{asset('storage/videos/'.$video->image)}}" width="200" height="200" alt="thumb" class="img-fluid" />
                    </div>
                    <div class="badge-positioned w-90">
                      <div class="d-flex justify-content-between align-items-center">
                        <span class="badge badge-danger font-weight-bold">{{$video->category->title}}</span>
